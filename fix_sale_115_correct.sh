...
echo "SAVDO 115 NI TO'G'RILASH:"
echo "=================================="
echo "HAQIQIY QIYMAT: total_amount = 19.00 (2 ta mahsulot)"
echo "Eski qiymat (xato tuzatish): cash_usd = 9.50"
echo "Yangi qiymat: cash_usd = 19.00"
echo ""
...
echo ""
echo "MAHSULOTLAR JAMI:"
sudo -u postgres psql xurshid_db -c "
SELECT 
    SUM(total_price) as jami_narx
FROM sale_items 
WHERE sale_id = 115;
"
